...
<script>
    ...
    report.forEach(row_rep => {
        console.log(row_rep);
        html_rep += `
        <tr>
            <td class="report_aspect">${row_rep[0]}</td>
            <td class="report_id">${row_rep[1]}</td>
            <td class="report_date">${row_rep[2]}</td>
            <td class="report_interval">${row_rep[3]}</td>
        </tr>
        `;
